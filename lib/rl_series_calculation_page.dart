...
import 'package:circuit_analysis_app/circuit_diagramRL.dart';
...
class _RLCalculationPageState extends State<RLCalculationPage> {
  ...
  Widget build(BuildContext context) {
    ...
    double iL = (widget.voltage / widget.resistance) *
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('RL Time Domain Analysis'),
      ),
            ...
            children: <Widget>[
              ...
              buildContentContainer(
                content: [
                  ...
                  centering(content: [
                    const CircuitDiagramRL(canvasheight: 165, canvaswidth: 340),
                  ]),
                  ...
                  const SizedBox(height: 15),
                  centering(content: [
                    Math.tex('V_L(t) = L \\frac{di(t)}{dt}',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle // Set the desired font size
                        ),
                    const SizedBox(height: 15),
                    Math.tex('V_R(t) = i(t) \\cdot R',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle // Set the desired font size
                        ),
                    const SizedBox(height: 15),
                  ...
                  const SizedBox(height: 15),
                  centering(content: [
                    Math.tex('L \\frac{di(t)}{dt} = V - i(t) \\cdot R',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle // Set the desired font size
                        ),
                  ]),
              ...
              buildContentContainer(
                content: [
                  ...
                  centering(content: [
                    ...
                    const SizedBox(height: 15),
                    Math.tex('\\frac{dt}{L} = \\frac{di}{(V - i(t) \\cdot R)}',
                        mathStyle: MathStyle.text,
                        textStyle: blueTextStyle // Set the desired font size
                        ),
                    const SizedBox(height: 15),
...
*/
              ...
              // Step 3
              buildStepContainer(
                title: 'Step 3 : Find the Inductor Current',
              ),
              ...
              buildContentContainer(
                content: [
                  Text('Solve the equation to find the current: ',
                      style: navyBlueTextStyleSmall),
                  const SizedBox(height: 15.0),
                  centering(content: [
                    Math.tex(
              ...
              // Step 4
              buildStepContainer(
                title: 'Step 4 : Find the Inductor Voltage',
              ),
              ...
              buildContentContainer(
                content: [
                  ...
                  centering(content: [
                    ...
                    const SizedBox(height: 15),
                    bordering(content: [
                      Math.tex('V_L(t) = V \\cdot e^{-\\frac{R \\cdot t}{L}}',
                          mathStyle: MathStyle.text,
                          textStyle: blueTextStyle // Set the desired font size
                          ),
                    ]),
              ...
              buildContentContainer(
                content: [
                  ...
                  const SizedBox(height: 15),
                  centering(content: [
                    Math.tex('\u03C4 = \\frac{L}{R}', textStyle: blueTextStyle),
                    const SizedBox(height: 15),
                    Math.tex(
